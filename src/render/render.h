...
/* Opaque handle to a GPU-resident mesh. RENDER_MESH_INVALID is never returned
...
/* Queue a mesh drawn with the given model matrix. Call before render_draw; the
   queue is cleared every frame. */
